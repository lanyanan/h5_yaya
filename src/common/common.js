/**
 * 点击分享按钮显示提示图片:http://images.9zhitx.com/f06d2cfd-9609-4b01-a0f4-abd645852b69.png
 */
/*
 *  date format
 */
...
function yayaDownLoadHref(){
	var yayaurl = 'http://api.9zhiad.com/router';
	...
	var browser = {
		...
		if (browser.versions.ios || browser.versions.iPhone || browser.versions.iPad) {
			...
			if(browser.versions.wx){
				...
				window.location="http://fastdfs.9zhiad.com:10170/apk/yygz.apk";
			}
		}else{
			window.location="http://www.21yaya.com/";	
		}
