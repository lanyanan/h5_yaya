...
var entrys_dir = [
	{ module: 'starPage', page: 'share' },
	{ module: 'allstar', page: 'index' },
	{ module: 'rules', page: 'index' },
	{ module: 'broadcast', page: 'index' },
	{ module: 'rule', page: 'index' },
];
var entry = {};
for(let x in entrys_dir){
	var entryKey = entrys_dir[x].module + '-' + entrys_dir[x].page;
	entry[entryKey] = './src/app/' + entrys_dir[x].module + '/entrys/'+entrys_dir[x].page;
	var HtmlPlugin = { 
		// favicon: './favicon.ico', //favicon路径，通过webpack引入同时可以生成hash值
		filename: 'html/' + entryKey + '.html', //生成的html存放路径，相对于path
		template: './src/app/' + entrys_dir[x].module + '/template/'+ entrys_dir[x].page +'.html', //html模板路径
		inject: 'body', //js插入的位置，true/'head'/'body'/false
		hash: true, //为静态资源生成hash值
		chunks: [entryKey],//需要引入的chunk，不配置就会引入所有页面的资源
		// minify: { //压缩HTML文件	
